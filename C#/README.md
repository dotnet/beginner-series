...
1. [What is C#]()
1. [Hello World!]()
1. [Hello World, Part 2]()
1. [The Basics of Strings]()
1. [Basics of VS Code and the C# Dev Kit]()
1. [Searching Strings]()
1. [Numbers, Integers, and Math]()
1. [Numbers, Precision, Casting, Doubles, and More]()
1. [Branching, Ifs, and Conditional Logic]()
1. [Branching and While Loops]()
1. [For Loops]()
1. [List<T> and Collections of Data]()
1. [Arrays, Lists, Indexing, and Foreach]()
1. [Sorting and Searching Lists]()
1. [Language Integrated Query (LINQ) and IEnumerable]()
1. [LINQ Query Expressions From, Where, Orderby, and Select]()
1. [LINQ Method Syntax vs Query]()
1. [Object-oriented Programming (OOP)]()
1. [OOP with derivated or abstract classes, overrides]()
...
## Video 5 : Basics of VS Code and the C# Dev Kit
...
## Video 19 : OOP with derivated or abstract classes, overrides
